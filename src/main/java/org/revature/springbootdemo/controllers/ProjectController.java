...
import org.revature.springbootdemo.exceptions.UserNotFoundException;
...
public class ProjectController {
    ...
    public ResponseEntity<Project> getProjectById(@PathVariable long project_id) throws UserNotFoundException {
    ...
    public ResponseEntity<Project> deleteProject(@PathVariable long project_id) throws UserNotFoundException {
